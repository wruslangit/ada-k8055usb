...
#include <sys/types.h>    // Added by WRY solved error: unknown u_int8_t, etc.
#include <string.h>
#include <stdio.h>
#include <usb.h>
#include <assert.h>
#include <math.h>
#include "ck8055.h"                 // Name modified by WRY 

// #define PATH_MAX    256           // Added by WRY in <usb.h> 
#define VERSION "Version 1.0 WRY"   // Added by WRY (char *)
#define STR_BUFF 256
#define PACKET_LEN 8
